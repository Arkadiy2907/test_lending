...
if (animItems.length > 0) {
	...
	function animScroll() {
		for (let i = 0; i < animItems.length; i++) {
			...
			let annimItemPoint = window.innerHeight - animItemHeight / animStart;

			if (animItemHeight > window.innerHeight) {
				annimItemPoint = window.innerHeight - window.innerHeight / animStart;
			}

			if ((pageYOffset > animItemOffset - annimItemPoint) && pageYOffset < (animItemOffset + animItemHeight)) {
